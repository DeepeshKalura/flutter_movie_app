...
import 'dummy_movies_screen.dart';
...
class DummiestMovieCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final posterUrl = 'http://image.tmdb.org/t/p/w500${movie.poster_path}';
  ...
  void navigateDetailPage(BuildContext context, DummyMovie movie) {
    final route = MaterialPageRoute(
      builder: (context) {
        return DummyMovieScreen(
          movie: movie,
        );
      },
    );
